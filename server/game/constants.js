...
const BOSS_FIREBALL_SPEED = 240;
const BOSS_FIREBALL_DMG = 22;
const BOSS_FIREBALL_LIFE = 3.0;
const BOSS_FIREBALL_RADIUS = 10;
...
const TIGER_COMPANION_HP      = 80;
const TIGER_COMPANION_RADIUS  = 14;
